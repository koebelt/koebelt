...
export const fr: Copy = {
  ...
  skills: {
    ...
    why: {
      ...
      dart: "Le langage de l'application mobile Cbienlà, écrite et maintenue quotidiennement depuis 2025. La sûreté du null et le modèle d'isolats sont les points qui m'ont demandé le plus de réflexion.",
      ...
      java: "Pratiqué en cours et en mission plutôt que porté de bout en bout. À l'aise pour lire et faire évoluer une base de code Java ; je voudrais un temps de montée en compétence avant d'en concevoir une.",
      node: "Backends, outillage et Cloud Functions. L'essentiel de ce que j'y ai appris concerne la boucle d'événements : ce qui la bloque, et l'effet que ça produit sur la latence en charge.",
      react: "Le framework avec lequel j'ai le plus construit, en mission comme pour moi. Ce site est en React, et la sphère en est délibérément tenue à l'écart : le moteur gère sa propre boucle et ne déclenche jamais de rendu, parce que 60 images par seconde et réconciliation ne font pas bon ménage.",
      ...
      angular: "J'ai travaillé sur des bases de code Angular en tant que consultant. L'injection de dépendances et RxJS ont demandé un temps d'adaptation ; c'est le framework de cette liste sur lequel j'aurais le plus besoin de me remettre à jour.",
      spring: "J'ai construit des services avec, en contexte JVM. Solide sur les bases — contrôleurs, injection de dépendances, persistance — mais je n'en ai pas exploité assez longtemps en production pour avoir un avis sur son réglage fin.",
      'react-native': "Du mobile avant Flutter. C'est ce qui me fait comprendre ce qu'un framework multiplateforme coûte réellement à la frontière du natif, et c'est précisément ce qui détermine si le choix était bon.",
      flutter: "L'application Cbienlà. J'en ai construit et livré les écrans, l'état et les intégrations plateforme, et j'ai traité les parties ingrates : liens profonds, état en arrière-plan et cycle de validation des stores.",
      aws: "EC2, S3 et IAM via les cours et des projets personnels. De quoi déployer et raisonner sur une facture ; pas de quoi concevoir une structure de comptes pour une équipe.",
